 ...
 * @author Ferox
 */
public class SelectCustomerForm extends FormLayout {
    ...
    public SelectCustomerForm() {
        ...
        comboBoxSelectCustomer = UIComboBox.getCustomerComboBox("SelectCustomer", "customerId", SelectCustomerBean.class, binder);
