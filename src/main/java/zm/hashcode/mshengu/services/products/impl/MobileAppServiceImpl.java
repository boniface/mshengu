...
public class MobileAppServiceImpl implements MobileAppService {
    ...
    public String deployUnitToSite(UnitDeliveryResource unitDelivery) {
        ...
        // create a new life cycle (deployment) for the toilet unit
        UnitLocationLifeCycle unitLifeCycle = persistUnitLocationLifeCycle(siteName, latitude, longitude);
        SiteUnit updatedSiteUnit = updatedSiteUnit(unitId, siteName, unitLifeCycle); //update toilet unite
        if (updatedSiteUnit != null) {
            // create a new life cycle (contract) for the toilet Site
            SiteServiceContractLifeCycle newSiteServiceContractLifeCycle = updateSiteServiceContractLifeCycleAdd(siteName, updatedSiteUnit);
